...
> 5 | <div no-update-body/>
    |             ^ (property) Marko.Directives["no-update-body"]?: AttrBoolean
...
```marko
  ...
  16 |
> 17 | <fancy-button message="hello" title="hello" onSelect() {}/>
     |                    ^ (property) Input.message?: string | undefined
...
```marko
  ...
  16 |
> 17 | <fancy-button message="hello" title="hello" onSelect() {}/>
     |                                    ^ (property) Input.title?: string | undefined
...
```marko
  ...
  23 | <fancy-button>
> 24 |   <@icon name="search"/>
     |         ^ (property) "@icon": Marko.AttrTag<{
    name: string;
    content?: Marko.Body<[info: {
        active: boolean;
    }], void>;
}> | undefined
